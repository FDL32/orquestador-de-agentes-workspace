...
- **Preflight de existencia de entregable (REC#3, RECHAZADA - ya existe):** la
  ...
  en FLT). Barrera viva, verificada. NO se aÃ±ade a 010r (seria duplicar gate).
...
## Segunda auditoria adversarial (Manager, 2026-06-17) â€” 2 refinamientos + 1 mejora nueva
...
- **REC#1, salvedad de rigor:** "comando reproducible citado" en markdown es
  ...
  sigue siendo 010s.
- **REC#2, gate ya vive (refuerza, no aÃ±ade):** `scripts/validate_ticket_prose.py`
...
- **MEJORA NUEVA â€” Impact Simulation faltante (--check-contract):** VERIFICADO:
