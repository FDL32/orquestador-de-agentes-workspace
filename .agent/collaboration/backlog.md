...
| Alta | WOT-2026-010w | Hardening de session-close: subprocess utf-8 en closeout_steps para Windows | motor/closeout-runtime | pending | WOT-2026-010v | session-2026-06-19-session-close-blocker |  <!-- follow-up verificado tras session-close dry-run fallido: support.py:40, support.py:287 y rotation.py:367 usan subprocess.run(text=True) sin encoding/errors. Objetivo: fijar encoding=\"utf-8\", errors=\"replace\" en los tres call sites y blindar con test de regresion del closeout. --> |
