...
| Alta | WOT-2026-011a | Archival-limbo: barrier de cierre o reconcile auditable (NO auto-commit v1) | motor/collab-hygiene | pending | WOT-2026-010w | session-2026-06-19-process-debt |  <!-- ~7 recurrencias esta sesion: archive_collaboration_artifacts.py mueve STRATEGY_/AUDIT_ via shutil.move SIN commit -> delete+untracked -> guard 010u dispara contaminacion_productiva -> reconcile manual + commit en cada cierre. Empezar por GUARD de cierre que falle/reconcile auditable (menor riesgo semantico). Auto-commit del archivador queda para un ticket de diseno corto posterior, NO v1. --> |
...
| Media | WOT-2026-011d | Retirada auditada de 7 stubs de prompts legacy (alias-compat de 008h/010a) | motor/legacy-deprecation | pending | WOT-2026-008h, WOT-2026-010g | session-2026-06-19-legacy-prompts |  <!-- 7 stubs '# Legacy alias:' en prompts/ (launch_builder, review_manager, session_bootstrap, session_close_chat, destination_bootstrap, refactor_bootstrap, audit_plan) apuntan a sus canonicos orchestrator_*/audit_ticket_contract. NO retirables aun: tienen CONSUMIDORES VIVOS verificados (rg 2026-06-19) que romperian: MANIFEST.distribute:45,53-57 (6/7 listados como motor distribuible); docs/registry/INDEX.md:32-50 (status=active, no legacy-retained -> --check-index fallaria); PROJECT.md:15 + .claude/rules/00-startup.md:5 + CLOSURE_MODEL.md (enlaces vivos a session_bootstrap/session_close_chat); tests/test_migration_bootstrap.py:614,636 (asserts sobre launch_builder.md); DEC-008D-001:89 (audit_plan.md citado como patron vivo de stub-alias). SECUENCIA: (1) reclasificar INDEX active->legacy-retained/alias-compat; (2) decidir si MANIFEST.distribute sigue listandolos; (3) repuntar consumidores vivos al nombre canonico orchestrator_*; (4) solo entonces borrar, con barrera que demuestre 0 consumidores. Usar prompt prompts/audit_portability_legacy_surface.md. Regla CEM: rg de consumidores antes de cualquier delete (memoria host-extends-cleanup-breaks-destino-resolvers). --> |
