...
| Alta | WOT-2026-010v | Hardening de encoding guard: detectar control chars <32 no-whitespace | motor/devex-encoding | pending | WOT-2026-010e, WOT-2026-008j | session-2026-06-19-encoding-hardening |  <!-- follow-up verificado tras 008f y 008j: check_encoding_guard.py y el hook post-write detectan BOM/mojibake/? pero dejan pasar control chars ASCII (<32) como VT/FF/NUL en archivos de texto. Objetivo: endurecer scripts/encoding_guard.py como fuente de verdad compartida para que check_encoding_guard.py y encoding_post_write_hook.py bloqueen control chars no-whitespace sin falsos positivos sobre tab/newline/CRLF ni binarios fuera de scope. --> |
