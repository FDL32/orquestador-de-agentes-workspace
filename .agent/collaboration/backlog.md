...
| Baja | WOT-2026-007g | Validador plan_graph: enforce paralelizable in {yes,no,after} + presencia Merge Regression Audit | motor/quality-gates | pending | WOT-2026-007c, WOT-2026-007e | session-2026-06-15-contract-formation |  <!-- follow-up explicito de 007e: extender validate_contract_formation.validate_plan_graph para chequear el VALOR de paralelizable y la presencia de la seccion Merge Regression Audit. Difundido fuera de 007c porque tocaba el validador en revision; 007c ya cerrado -->
| Baja | WOT-2026-007f | Integracion runtime de CONTRACT_GAP en bus/controller | motor/protocol-runtime | needs-rebase | WOT-2026-007c | session-2026-06-14-contract-formation |  <!-- NEEDS-REBASE: el contrato cambio en 007c (campos requeridos nuevos: Premise Re-check, Context Baseline; requested_resolution) y 007e (Merge Audit, paralelizable yes/no/after). Rebase obligatorio sobre el contrato final antes de tocar runtime -->
