...
| WOT-2026-013t | completed | cerrado canonico 2026-06-25 (COMPLETED + SUPERVISOR_CLOSED en bus, commit motor a1b99af, suite 3200 passed @ HEAD, validate 0/0); UpgradeManager consolidado en un unico owner editable (scripts.upgrade_agent_system) con scripts.upgrade como re-export y copy-seam shutil/datetime inequivoco; cierra la familia 013 sin tickets vivos. Paso 2 de 013r (FP-012). Archivado desde cola viva 2026-06-26. |
...
## Movido por cierre canonico lote WOT-2026-014x (COMPLETED 2026-06-27)

> Lote de 8 tickets de optimizacion del motor cerrados canonicamente en la sesion 2026-06-27.
> Cada uno con commit productivo en repo_motor y bus terminal (STATE_CHANGED->COMPLETED + SUPERVISOR_CLOSED).
> 014i ademas cito evidencia primaria CI (workflows verdes, 0 anotaciones Node-20) en motor+workspace.

| Prioridad | Ticket | Titulo | Scope | Estado | Depende de | Origen | Reactivation |
|-----------|--------|--------|-------|--------|------------|--------|--------------|
| Media | WOT-2026-014a | closeout self-dirty: prepush (delivery_hygiene) bloquea por el session_close_report.md que el cierre escribe | motor/closeout-hygiene | pending | - | session-2026-06-26-cleanup-triage | - |  <!-- completed: motor fe8ac4b; manager APPROVE; bus COMPLETED+SUPERVISOR_CLOSED -->
| Media | WOT-2026-014b | run_pytest_safe asume pytest; falso rojo en repos destino que usan unittest | motor/test-runner-portability | pending | - | session-2026-06-26-extractor-EXF-2026-005a | - |  <!-- completed: motor 41347e2; manager APPROVE; bus COMPLETED+SUPERVISOR_CLOSED -->
| Alta | WOT-2026-014d | Re-encodar SKILL.md builder-self-audit + ampliar SUSPICIOUS_CODEPOINTS del guard | motor/devex-encoding | pending | - | session-2026-06-26-docs-audit | - |  <!-- completed: motor 0adde7f; manager APPROVE; bus COMPLETED+SUPERVISOR_CLOSED -->
| Media | WOT-2026-014e | Unificar resolve_motor_root en motor_link (drift .resolve() ausente) | motor/topology-resolution | pending | - | session-2026-06-26-docs-audit | - |  <!-- completed: motor c2ff098 + e1b1030; manager APPROVE; bus COMPLETED+SUPERVISOR_CLOSED -->
| Media | WOT-2026-014f | Unificar helpers de descubrimiento/parseo de manager_feedback (3 copias -> 1 canonica importada) | motor/closeout-hygiene | pending | - | session-2026-06-26-docs-audit | - |  <!-- completed: motor 101a6012; manager APPROVE; bus COMPLETED+SUPERVISOR_CLOSED -->
| Media | WOT-2026-014g | Desync frontmatter name vs carpeta en 6 skills + gate name==dir ausente | motor/skills-discovery | pending | - | session-2026-06-26-docs-audit | - |  <!-- completed: motor 651fe66; manager APPROVE; bus COMPLETED+SUPERVISOR_CLOSED -->
| Baja | WOT-2026-014h | Extraer scope-verification del orquestador.py DEPRECATED | motor/legacy-deprecation | pending | - | session-2026-06-26-docs-audit | - |  <!-- completed: motor ac08dcb; manager APPROVE; bus COMPLETED+SUPERVISOR_CLOSED -->
| Baja | WOT-2026-014i | Bump GitHub Actions a versiones no-Node20 (checkout/setup-python/upload-artifact) en workflows motor+workspace | ci/actions-version-bump | pending | - | session-2026-06-26-security-audit-flake | - |  <!-- completed: motor cef7e52+960b3e2, workspace 6014654+761b038; CI 0 Node-20 annotations; manager APPROVE; bus COMPLETED+SUPERVISOR_CLOSED -->
...
- **Cierre (lote 014x, 2026-06-27):** completed. motor fe8ac4b; manager APPROVE; bus COMPLETED+SUPERVISOR_CLOSED.
...
- **Cierre (lote 014x, 2026-06-27):** completed. motor 41347e2; manager APPROVE; bus COMPLETED+SUPERVISOR_CLOSED.
...
- **Cierre (lote 014x, 2026-06-27):** completed. motor 0adde7f; manager APPROVE; bus COMPLETED+SUPERVISOR_CLOSED.
...
- **Cierre (lote 014x, 2026-06-27):** completed. motor c2ff098 + e1b1030; manager APPROVE; bus COMPLETED+SUPERVISOR_CLOSED.
...
- **Cierre (lote 014x, 2026-06-27):** completed. motor 101a6012; manager APPROVE; bus COMPLETED+SUPERVISOR_CLOSED.
...
- **Cierre (lote 014x, 2026-06-27):** completed. motor 651fe66; manager APPROVE; bus COMPLETED+SUPERVISOR_CLOSED.
...
- **Cierre (lote 014x, 2026-06-27):** completed. motor ac08dcb; manager APPROVE; bus COMPLETED+SUPERVISOR_CLOSED.
...
- **Non-goal:** NO cambiar la logica ni los pasos de ningun job (solo las versiones de las
  ...
  necesita.
- **Cierre (lote 014x, 2026-06-27):** completed. motor cef7e52+960b3e2, workspace 6014654+761b038; CI 0 Node-20 annotations; manager APPROVE; bus COMPLETED+SUPERVISOR_CLOSED.
