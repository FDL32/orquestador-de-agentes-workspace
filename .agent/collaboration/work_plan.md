...
- La tabla clasifica 21 prompts fisicos: 6 orchestrator_* relacionados (5 futuros renames y orchestrator_pipeline.md ya canonico), 1 manager_*, 11 audit_* family, 1 memory_* family, 1 contract_formation_* family y 2 legacy stubs (`audit_plan.md`, `review_manager.md`).
