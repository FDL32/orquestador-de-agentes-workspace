...
- **Premise Re-check (read-only):**
  ...
  - inventariar `prompts/*.md` y confirmar 20 archivos fisicos;
...
- **Context Baseline Evidence:** 008f_state=COMPLETED; prompts_fisicos=20; skills_man_bui=8 dirs; generated_at=2026-06-18.
- **Files Likely Touched:**
