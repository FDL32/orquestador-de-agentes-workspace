...
#### R-010: When a ticket is re-scoped or closed through follow-up reviews, the backlog tabl
...
#### R-017: Ticket WT-2026-251a completado: ** Centralizar ticket-ID regex y extender a pref
...
#### R-019: Any regex, import path, literal string, or code snippet inside a plan acts as ex
...
#### R-020: Before closing a technical plan, verify proposed test file paths against the fil
...
#### R-021: Before freezing 'Tests Esperados' in a plan or audit, verify whether each named
...
#### R-022: For concurrency or cross-process coordination fixes, passing tests is necessary
...
#### R-023: For one-line fixes with high regression risk, the minimum useful contract is sma
...
#### R-024: The Manager is not an untouchable narrator layer. If the fault lives in review i
...
#### R-025: The strongest review role is an auditor who searches for counterexamples in the
...
#### R-026: When a planning correction lands during review, apply it to both `work_plan.md`
...
#### R-018: UTF-8 with BOM can make lightweight validators and Windows subprocess readers fa
...
#### R-027: For validators with multiple failure modes, keep tests orthogonal: each test sho
