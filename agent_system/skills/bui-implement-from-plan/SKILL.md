...
author: agent-system
tags: [builder, implementation, coding, execution]
triggers: [/implement, implement]
---
...
Leer en orden:
1. `.builder_rules` - restricciones del rol
...
# Verificar linting
uv run ruff check src/[archivo].py
```
...
- `.builder_rules` - Restricciones del rol
