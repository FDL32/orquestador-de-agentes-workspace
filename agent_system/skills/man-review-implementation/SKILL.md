...
author: agent-system
tags: [manager, review, quality, verification]
...
Leer en orden:
1. `.manager_rules` - restricciones del rol
...
| **Hub nodes** | Si tocaste un Hub Node (ver `GRAPH_REPORT.md`), Â¿el log explica cÃ³mo se protegiÃ³ la retrocompatibilidad? |
...
- `.manager_rules` - Restricciones del rol Manager
