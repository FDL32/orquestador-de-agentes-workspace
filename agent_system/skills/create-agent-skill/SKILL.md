...
author: agent-system
tags: [meta, skill-creation, template, generator]
triggers: [/create-skill, skill-create]
---
...
author: agent-system
tags: [tag1, tag2, tag3]
triggers: [/keyword1, keyword2]  # â† OPCIONAL: Palabras clave para descubrimiento automÃ¡tico
---

**Campos opcionales:**
- `triggers` (lista de strings): Palabras clave o comandos que activan automÃ¡ticamente esta skill.
  Formato: `/comando` o `palabra`. Ejemplo: `triggers: [/codereview, review, code-review]`
  Uso: Cuando se integren clientes como Goose o Claude Code CLI, podrÃ¡n invocar skills por triggers.
  Si no usas triggers, simplemente omite este campo.
